...
void BoardIndicator::initialize() { boardIndicator_initialize(); }

void BoardIndicator::update() { boardIndicator_update(); }

void BoardIndicator::write(int index, bool value) {
